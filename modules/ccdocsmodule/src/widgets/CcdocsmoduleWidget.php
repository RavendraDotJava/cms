...
namespace modules\ccdocsmodule\widgets;

use modules\ccdocsmodule\Ccdocsmodule;
use modules\ccdocsmodule\assetbundles\ccdocsmodulewidgetwidget\CcdocsmoduleWidgetWidgetAsset;
 ...
 * @since     1.0,0
 */
class CcdocsmoduleWidget extends Widget
{
    ...
    {
        return Craft::t('ccdocsmodule', 'Documentation');
    }
    ...
    {
        return Craft::getAlias("@modules/ccdocsmodule/assetbundles/ccdocsmodulewidgetwidget/dist/img/CcdocsmoduleWidget-icon.svg");
    }
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CcdocsmoduleWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'ccdocsmodule/_components/widgets/CcdocsmoduleWidget_body',
            [
